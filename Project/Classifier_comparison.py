...
# -*- coding: utf-8 -*-
"""
Comparing the Classifiers under noisy labels

source : https://github.com/cgnorthcutt/cleanlab/blob/master/examples/classifier_comparison.ipynb
"""
...
##########################################################################################
######################### Run the classifiers on datasets ###############################
...
for e_i, experiment in enumerate([
    ...
    plt.tight_layout()
    if save_figures:
        _ = plt.savefig('{}.png'.format(experiment), pad_inches=0.0, bbox_inches='tight')
